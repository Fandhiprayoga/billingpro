    ...
    columns: [
      ...
      { data: null, orderable: false,
        render: function(data, type, row) {
          var html = '';
          if (canView) {
            html += '<a href="<?= base_url('admin/trial-licenses/view/') ?>' + row.id + '" class="btn btn-sm btn-info" title="Detail"><i class="fas fa-eye"></i></a> ';
          }
          if (canRevoke && row.status === 'active') {
            html += '<form action="<?= base_url('admin/trial-licenses/revoke/') ?>' + row.id + '" method="post" class="d-inline" onsubmit="return confirm(\'Yakin ingin mencabut lisensi trial ini?\')">';
