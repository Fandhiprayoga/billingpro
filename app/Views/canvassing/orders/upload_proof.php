      ...
      <div class="card-body">
        ...
        <div class="alert alert-primary">
          ...
          <table class="table table-sm table-borderless mb-0 mt-2">
            <tr><td width="110"><strong>Bank</strong></td><td><span class="font-weight-bold"><?= esc($bankInfo['bank_name']) ?></span></td></tr>
            <tr><td><strong>No. Rekening</strong></td><td><code class="h6 mb-0"><?= esc($bankInfo['account_number']) ?></code></td></tr>
            <tr><td><strong>Atas Nama</strong></td><td><strong><?= esc($bankInfo['account_name']) ?></strong></td></tr>
          </table>
        </div>
        <?php endif; ?>

        <form action="<?= base_url('canvassing/customer-orders/submit-proof/' . $order->order_number) ?>" method="post" enctype="multipart/form-data">
          <?= csrf_field() ?>
          ...
          <div class="form-group text-right">
            <a href="<?= base_url('canvassing/customer-orders/view/' . $order->order_number) ?>" class="btn btn-secondary mr-1">Batal</a>
