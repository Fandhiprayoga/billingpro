<div class="row">
  <div class="col-12 col-md-8 offset-md-2">
    <div class="card">
      ...
      <div class="card-body">
        <form action="<?= base_url('admin/orders/store') ?>" method="post">
          <?= csrf_field() ?>
          ...
          <div class="form-group">
            ...
            <div class="row">
              ...
              <?php else: ?>
                <div class="col-12">
                  <div class="alert alert-warning">Belum ada paket tersedia. Silakan buat paket terlebih dahulu.</div>
                </div>
              <?php endif; ?>
            </div>
          </div>
          ...
          <div class="form-group text-right">
            <a href="<?= base_url('admin/orders') ?>" class="btn btn-secondary mr-1">Batal</a>
