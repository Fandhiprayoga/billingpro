    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="alert alert-info">
          ...
          <strong>Jumlah:</strong> Rp <?= number_format($order->amount, 0, ',', '.') ?>
        </div>

        <form action="<?= base_url('admin/orders/submit-confirmation/' . $order->order_number) ?>" method="post" enctype="multipart/form-data">
          <?= csrf_field() ?>
          ...
          <div class="form-group text-right">
            <a href="<?= base_url('admin/orders/view/' . $order->order_number) ?>" class="btn btn-secondary mr-1">Batal</a>
